...
_Last run: **2026-06-21 12:45 UTC** · image `latest` · runner `Linux x86_64` · single cold run, indicative only._

| Project | Lang | Commit | LOC | Files | Nodes | Relations | Time | Peak RSS | KLOC/s | Resolver | Resolved |
|---|---|---|--:|--:|--:|--:|--:|--:|--:|:--|--:|
| [apache/superset](https://github.com/apache/superset) | python | `c83fb2b` | 399 519 | 1 886 | 156 268 | 379 813 | 136.5s | 2,051 MB | 2.9 | ok | 84% of 281 667 (68s) |
| [colinhacks/zod](https://github.com/colinhacks/zod) | typescript | `1fb56a5` | 74 194 | 404 | 8 741 | 25 258 | 18.3s | 646 MB | 4.1 | ok | 91% of 15 771 (14s) |
| [gin-gonic/gin](https://github.com/gin-gonic/gin) | go | `73726dc` | 23 672 | 98 | 7 227 | 11 882 | 13.2s | 2,102 MB | 1.8 | ok | 100% of 8 920 (12s) |
| [casdoor/casdoor](https://github.com/casdoor/casdoor) | go | `696bcf0` | 86 898 | 458 | 14 987 | 28 276 | 129.3s | 14,576 MB | 0.7 | ok | 100% of 19 421 (126s) |
| [gohugoio/hugo](https://github.com/gohugoio/hugo) | go | `4d22555` | 224 821 | 897 | 34 809 | 72 225 | 106.8s | 9,468 MB | 2.1 | ok | 99% of 49 013 (100s) |
| [BurntSushi/ripgrep](https://github.com/BurntSushi/ripgrep) | rust | `4649aa9` | 50 275 | 98 | 7 691 | 10 001 | 150.9s | 2,354 MB | 0.3 | ok | 54% of 11 435 (146s) |
| [tokio-rs/axum](https://github.com/tokio-rs/axum) | rust | `c59208c` | 43 653 | 296 | 8 422 | 9 673 | 984.7s | 8,888 MB | 0.0 | ok | 35% of 9 662 (893s) |
| [astral-sh/ruff](https://github.com/astral-sh/ruff) | rust | `6686f63` | 687 409 | 1 870 | 52 047 | 62 214 | 34.8s | 1,505 MB | 19.8 | ok | 0% of 155 276 (1s) |
