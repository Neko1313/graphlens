...
_Last run: **2026-06-21 10:52 UTC** · image `latest` · runner `Linux x86_64` · single cold run, indicative only._

| Project | Lang | Commit | LOC | Files | Nodes | Relations | Time | Peak RSS | KLOC/s | Resolver |
|---|---|---|--:|--:|--:|--:|--:|--:|--:|:--|
| [apache/superset](https://github.com/apache/superset) | python | `c83fb2b` | 399 519 | 1 886 | 156 266 | 379 813 | 136.7s | 1,754 MB | 2.9 | ok |
| [colinhacks/zod](https://github.com/colinhacks/zod) | typescript | `1fb56a5` | 74 194 | 404 | 8 741 | 25 258 | 18.1s | 650 MB | 4.1 | ok |
| [gin-gonic/gin](https://github.com/gin-gonic/gin) | go | `73726dc` | 23 672 | 98 | 7 227 | 11 882 | 15.6s | 834 MB | 1.5 | ok |
| [casdoor/casdoor](https://github.com/casdoor/casdoor) | go | `696bcf0` | 86 898 | 458 | 14 987 | 28 276 | 102.5s | 11,121 MB | 0.8 | ok |
| [gohugoio/hugo](https://github.com/gohugoio/hugo) | go | `4d22555` | 224 821 | 897 | 34 789 | 72 142 | 156.2s | 13,971 MB | 1.4 | ok |
| [BurntSushi/ripgrep](https://github.com/BurntSushi/ripgrep) | rust | `4649aa9` | 50 275 | 98 | 10 663 | 14 964 | 875.4s | 2,004 MB | 0.1 | ok |
| [tokio-rs/axum](https://github.com/tokio-rs/axum) | rust | `c59208c` | 43 653 | 296 | 8 393 | 11 602 | 274.0s | 6,721 MB | 0.2 | ok |
| [astral-sh/ruff](https://github.com/astral-sh/ruff) | rust | `6686f63` | 687 409 | 1 870 | 52 047 | 62 214 | 35.6s | 1,463 MB | 19.3 | ok |
| **Total** | | | **1 590 441** | | **293 113** | | **1614.2s** | | **1.0** | |
