...
_Last run: **2026-06-21 10:01 UTC** · image `latest` · runner `Linux x86_64` · single cold run, indicative only._

| Project | Lang | Commit | LOC | Files | Nodes | Relations | Time | Peak RSS | KLOC/s | Resolver |
|---|---|---|--:|--:|--:|--:|--:|--:|--:|:--|
| [apache/superset](https://github.com/apache/superset) | python | `c83fb2b` | 399 519 | 1 886 | 156 251 | 379 813 | 147.5s | 1,755 MB | 2.7 | ok |
| [colinhacks/zod](https://github.com/colinhacks/zod) | typescript | `1fb56a5` | 74 194 | 404 | 8 741 | 25 258 | 18.9s | 644 MB | 3.9 | ok |
| [gin-gonic/gin](https://github.com/gin-gonic/gin) | go | `73726dc` | 23 672 | 98 | 2 434 | 2 979 | 0.7s | 75 MB | 35.2 | unavailable |
| [casdoor/casdoor](https://github.com/casdoor/casdoor) | go | `696bcf0` | 86 898 | 458 | 6 769 | 8 855 | 1.8s | 208 MB | 48.3 | unavailable |
| [gohugoio/hugo](https://github.com/gohugoio/hugo) | go | `4d22555` | 224 821 | 897 | 18 036 | 23 793 | 4.9s | 448 MB | 46.1 | unavailable |
| [BurntSushi/ripgrep](https://github.com/BurntSushi/ripgrep) | rust | `4649aa9` | 50 275 | 98 | 3 704 | 3 773 | 1.1s | 54 MB | 45.9 | unavailable |
| [tokio-rs/axum](https://github.com/tokio-rs/axum) | rust | `c59208c` | 43 653 | 296 | 5 347 | 6 335 | 1.3s | 50 MB | 32.8 | unavailable |
| [astral-sh/ruff](https://github.com/astral-sh/ruff) | rust | `6686f63` | 687 409 | 1 870 | 52 047 | 62 214 | 17.4s | 451 MB | 39.5 | unavailable |
| **Total** | | | **1 590 441** | | **253 329** | | **193.5s** | | **8.2** | |
