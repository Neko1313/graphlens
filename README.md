...
_Last run: **2026-07-24 11:11 UTC** · image `latest` · runner `Linux x86_64` · single cold run, indicative only._
...
| [colinhacks/zod](https://github.com/colinhacks/zod) | typescript | `1fb56a5` | 74 194 | 404 | 8 623 | 24 557 | 21.5s | 650 MB | 3.4 | ok | 87% of 15 771 (18s) |
| [gin-gonic/gin](https://github.com/gin-gonic/gin) | go | `73726dc` | 23 672 | 98 | 7 227 | 11 882 | 14.2s | 2,190 MB | 1.7 | ok | 100% of 8 920 (13s) |
| [casdoor/casdoor](https://github.com/casdoor/casdoor) | go | `696bcf0` | 86 898 | 458 | 14 987 | 28 276 | 143.8s | 14,476 MB | 0.6 | ok | 100% of 19 421 (137s) |
| [gohugoio/hugo](https://github.com/gohugoio/hugo) | go | `4d22555` | 224 821 | 897 | 34 809 | 72 225 | 110.3s | 9,236 MB | 2.0 | ok | 99% of 49 013 (104s) |
...
| [tokio-rs/axum](https://github.com/tokio-rs/axum) | rust | `c59208c` | 43 653 | 296 | 8 093 | 14 798 | 89.2s | 4,543 MB | 0.5 | ok | 88% of 9 662 (1s) |
| [astral-sh/ruff](https://github.com/astral-sh/ruff) | rust | `6686f63` | 687 409 | 1 870 | 69 708 | 217 127 | 249.2s | 8,314 MB | 2.8 | ok | 100% of 155 276 (13s) |
...
| **Total** | | | **2 120 420** | | **467 458** | | **943.7s** | | **2.2** | | **75% of 841 524** |
