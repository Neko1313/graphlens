...
- **csharp**: feat(csharp): add C# language adapter by @Neko1313 in [#37](https://github.com/Neko1313/graphlens/pull/37)

### Performance

- **adapters**: perf(adapters): single resolver session per analyze() call + PHP resolver migration by @Neko1313 in [#36](https://github.com/Neko1313/graphlens/pull/36)




**Full Changelog**: https://github.com/Neko1313/graphlens/compare/v0.7.1...v0.8.0
## [0.7.1] - 2026-06-27
### Bug Fixes
...
- **cli**: drop built-in mcp server in favor of standalone graphlens-mcp
...
- **adapters**: support nested same-language monorepo roots
...
- @Neko1313 made their first contribution in [#6](https://github.com/Neko1313/graphlens/pull/6)
